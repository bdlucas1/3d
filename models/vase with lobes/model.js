detail = ui.slider({name: 'detail', min: 10, max: 50, value: 30})
...
profile = ui.curve({name: 'profile', kind: 'hybrid', value: pts})

nLobes = ui.slider({name: 'n lobes', min: 1, max: 30, value: 3})
lobeHeight = ui.slider({name: 'lobe height', min: 0, max: 0.2, step: 0.001, value: 0.150})
lobeHorProfile = ui.curve({name: 'lobe h profile', kind: 'poly', value: [{x:0, y:0}, {x:0.5, y:1}, {x:1, y:0}]})
lobeVerProfile = ui.curve({name: 'lobe v profile', kind: '1 wave', value: [{x:0, y:0}, {x:0.5, y:1}, {x:1, y:0}]})
